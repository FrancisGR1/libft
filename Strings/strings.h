...
void				str_replace(t_string *str1, const char *old_str,
						const char *new_str);
void				str_replace_all(t_string *str, const char *old_str,
						const char *new_str);
...
// copy
size_t				str_copy(const t_string *str, char *buffer, size_t pos,
						size_t len);
...
// search
int					str_find(const t_string *str, const char *buffer,
						size_t pos);
int					str_rfind(const t_string *str, const char *buffer,
						size_t pos);
int					str_find_first_of(const t_string *str, const char *buffer,
						size_t pos);
int					str_find_last_of(const t_string *str, const char *buffer,
						size_t pos);
