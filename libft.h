...
void				*ft_memcat(void *dst, void *src, size_t dst_offset,
						size_t data_cnt);
...
void				str_free_and_replace_str(t_string *str,
						t_string *substitute);
int					string_find(t_string str, size_t start, size_t n,
						char *delimiters);
t_string			string_find_word(t_string str, size_t start,
						t_string target);
