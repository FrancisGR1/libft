...
SOURCES = ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c ft_strlen.c ft_isspace.c \
	...
	arena.c ft_realloc.c freen.c dynamic_array.c strings.c\
